...
```
SEEDANCE 2.0 ON HHiggsfield COMIC ANIMATION PROMPT
[TITLE OF SEQUENCE]
...
```
SEEDANCE 2.0 ON HHiggsfield COMIC ANIMATION
...
```
SEEDANCE 2.0 ON HHiggsfield MULTI-PAGE COMIC ANIMATION
...
NOTE TO SEEDANCE 2.0 ON HHiggsfield:
...
Seedance 2.0 on Higgsfield should weight prompt tokens toward primary narrative focus.
```
