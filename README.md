🌐 **English** | [简体中文](README.zh-CN.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Español](README.es.md) | [Deutsch](README.de.md) | [Français](README.fr.md) | [Português](README.pt.md) | [Türkçe](README.tr.md) | [繁體中文](README.zh-TW.md)
...
- **Material Reference Strategy** — Best practices for `@image1` `@video1` `@audio1` references
- **Platform Optimization** — TikTok, Instagram, YouTube, and more
...
| # | Skill | Use Case |
|---|---|---|
| 01 | [Cinematic](skills/01-cinematic/SKILL.md) | Film quality — dramatic lighting, camera language, depth of field, color grading |
...
| 11 | [Social Hook](skills/11-social-hook/SKILL.md) | Viral content — scroll-stopping TikTok/Reels/Shorts hooks |
...
> 📝 Each skill also has a Simplified Chinese version: `skills/XX-name/zh-CN/SKILL.md`
...
**Automatic (macOS / Linux / Windows Git Bash):**
...
Skills install to Claude Code's skills directory: `~/.claude/skills`
...
4. Paste it into [Seedance 2.0 on Higgsfield](https://higgsfield.ai/create/video?model=seedance_2_0) with your materials
...
Claude (with the cinematic skill):
→ Generates a 25+ line detailed prompt
→ With timeline, camera, lighting, sound, and a 2-second hook
```

---

## 📋 Seedance 2.0 (Higgsfield) Specs
...
| **Combined** | — | **≤ 12 files** |
| **Output** | Video | **4–15s, 480p/720p/1080p/native 4K, with sound** |
...
└── skills/
    ├── 01-cinematic/
    │   ├── SKILL.md                   # English
    │   └── zh-CN/SKILL.md             # Simplified Chinese
    ├── 02-3d-cgi/
    ├── 03-cartoon/
    ├── 04-comic-to-video/
    ├── 05-fight-scenes/
...
- **Skills:** 15
- **Total files:** 30 SKILL.md (15 EN + 15 ZH)
- **Total lines:** 31,725+
...
1. Follow the SKILL.md format (YAML frontmatter + content)
2. Include the 2-Second Hook Framework
3. Include 5+ large example prompts
4. Provide English (Chinese optional) versions
5. Test on [Seedance 2.0 on Higgsfield](https://higgsfield.ai/create/video?model=seedance_2_0)
